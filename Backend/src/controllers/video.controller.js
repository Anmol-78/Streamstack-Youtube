...
const publishAVideo = asyncHandler(async (req, res) => {
    ...
    // Remove the error throw for missing thumbnail
    ...
    if (thumbnailLocalPath) {
        ...
        // Set a default thumbnail URL (replace with your actual default image URL)
        thumbnail = { url: "https://via.placeholder.com/320x180?text=No+Thumbnail" };
    }
