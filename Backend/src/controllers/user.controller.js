...
const registerUser = asyncHandler( async (req, res) => {
    ...
    // Remove the error throw for missing avatar
    ...
    if (avatarLocalPath) {
        ...
        // Set a default avatar URL (replace with your actual default image URL)
        avatar = { url: "https://ui-avatars.com/api/?name=User" };
    }
    const coverImage = await uploadOnCloudinary(coverImageLocalPath);


    // Remove the error throw for missing avatar upload
